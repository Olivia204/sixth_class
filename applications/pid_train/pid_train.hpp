#ifndef PID_TRAIN_HPP
#define PID_TRAIN_HPP
...
public:
	...
	void calc_1(float set, float fdb);
	void calc_2(float set, float fdb);
	void calc_3(float set, float fdb);
	void calc_4(float set, float fdb);
